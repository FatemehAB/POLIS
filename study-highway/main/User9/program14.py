...
def heuristic(s):
    ...
    if (car1_y_pos == your_y_pos and car1_x_pos - your_x_pos < 60) or (car2_y_pos == your_y_pos and car2_x_pos - your_x_pos < 30):
         action = 0
    # If there is a car in the right lane, do not move.
    elif (car1_y_pos == your_y_pos + 4 and car1_x_pos - your_x_pos < 60) or (car2_y_pos == your_y_pos + 4 and car2_x_pos - your_x_pos < 30):
        action = 1
    else:
        action = 2
