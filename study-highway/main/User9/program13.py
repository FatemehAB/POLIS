...
def heuristic(s):
    ...
    current_lane_occupied_car1 = car1_y_pos == your_y_pos and car1_x_pos - your_x_pos < 60
    current_lane_occupied_car2 = car2_y_pos == your_y_pos and car2_x_pos - your_x_pos < 60

    right_lane_occupied_car1 = car1_y_pos == your_y_pos + 4 and car1_x_pos - your_x_pos < 60
    right_lane_occupied_car2 = car2_y_pos == your_y_pos + 4 and car2_x_pos - your_x_pos < 60
    
    # If there is a car in the lane, move back up.
    if (car1_y_pos == your_y_pos and car1_x_pos - your_x_pos < 60) or (car2_y_pos == your_y_pos and car2_x_pos - your_x_pos < 60):
         action = 0
    # If there is a car in the right lane, do not move.
    elif (car1_y_pos == your_y_pos + 4 and car1_x_pos - your_x_pos < 60) or (car2_y_pos == your_y_pos + 4 and car2_x_pos - your_x_pos < 60):
        action = 1
    else:
        action = 2
